...
async def contributor(e):
    await e.edit("[MoveAngel](https://t.me/afdulfauzan)")
...
async def reedme(e):
    await e.edit(
        ...
        "\n[One4uBot's README.md file](https://github.com/afdulfauzan/NangisBot/blob/nangis/README.md)"
...
async def repo_is_here(wannasee):
    ...
    await wannasee.edit(
        "[Click Here !!!](https://github.com/afdulfauzan/NangisBot) to open NangisBot GitHub page."
    )
